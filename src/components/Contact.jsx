...
function Contact() {
  return (
    <div className='text-center p-5 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
      ...
      <form className='max-w-2xl mx-auto text-gray-600 pt-8'>
        <div className='flex flex-wrap'>
            <div className='w-full md:w-1/2 text-left '>
                ...
                <input name='Name' className='w-full border border-gray-300 rounded py-3 px-4 mt-2' id='name' type="text" placeholder='Your Name'  required/>
            </div>
            <div className='w-full md:w-1/2 text-left'>
                <label htmlFor="email">Your Email</label> 
                <input name='Email' className='w-full border border-gray-300 rounded py-3 px-4 mt-2' id='email' type="email" placeholder='Your Email'  required/>
            </div>
        </div>
