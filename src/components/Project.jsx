...
const Project = () => {
  ...
  return (
    <div className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
      ...
      <p className='text-gray-500 mx-auto max-w-80 text-center mb-8'>Crafting Spaces, Building Legacies—Explore Our Portfolio
      </p>

      {/* slider button */}
      <div className='flex justify-end items-center mb-8'>
        <button onClick={prevProject} className='p-3 bg-gray-100 rounded mr-2' aria-label='previous Project'>
          <img src={assets.left_arrow} alt="" />
        </button>
        <button onClick={nextProject} className='p-3 bg-gray-100 rounded mr-2' aria-label='next Project'>
